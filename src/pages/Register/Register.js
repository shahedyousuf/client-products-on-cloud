...
const Register = () => {
    ...
    return (
        <div>
            <h2 className='text-accent ml-10 p-2 mb-2 text-2xl font-bold'>Register user</h2>
            <>
                <form onSubmit={handleRegister}>
                    <input onChange={handleName} className='mb-2 p-2 ml-10 border border-gray-400 w-1/2' type="text" name="name" placeholder='Enter your name' required />
                    <br />
                    ...
                    <br />
                    <input onChange={handleConfirmPassword} className='mb-2 p-2 ml-10 border border-gray-400 w-1/2' type="password" name="password" placeholder='Repeat password' required />
                    <br />
